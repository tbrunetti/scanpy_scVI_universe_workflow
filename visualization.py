...
@profile
def plot_reductions(anndata_obj:AnnData, reduction_name:str, layer:str, ncol_layout:int,  categorical_col:str, continuous_col:str, marker:str, groupby_col:str, file_savename:str, paths_config:PathConfig) -> None:
     '''
     For plotting umap:
